...
describe("retrieveProduct", function () {
  test("SHOULD successfully retrieve a product RESPOND with status code and data", /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee() {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            cartFunction.retrieveProduct = jest.fn().mockReturnValue({
              data: expectedData,
              status: expectedStatus
            });
            _context.next = 7;
            return retrieveProduct(req, res);
